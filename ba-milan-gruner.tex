...
\begin{document}
  ...
  Here, all businesses that are connected via ownership-related were considered
  as a company group.
  ...
  all relations (in $ownershipRelations$) that concern this particular subgraph, e.g. "ownedBy".
