...
\begin{document}
  ...
  to compute the relative likelihood that a user might arrive at a web page
  ...
  Therefore, the vertex output of the PageRank algorithm can be interpreted as the
  ...
  The relation output can be seen as the probability that the user
