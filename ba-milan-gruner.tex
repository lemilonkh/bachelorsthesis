...
\begin{document}
  ...
  \section{The German Corporate Graph Project}
    \subsection[Why a German Corporate Graph?]{Why a German Corporate Graph?\footnote{This and the next section was authored by Matthias Radscheit \cite{loeperradscheit}.}}
