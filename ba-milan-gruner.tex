...
\definecolor{keywordcolor}{rgb}{0.7,0.4,0}
...
\begin{document}
  ...
  \section{Using Apache Spark and GraphX for Graph Analysis}
    \subsection{Motivation: Why Spark, Cassandra and GraphX?}
    \subsection{The Spark GraphX vertex and edge data structures}
    \subsection{Transforming $Subjects$ into GraphX compatible relation data}
