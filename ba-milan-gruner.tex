...
\begin{document}
  ...
  The companies extracted in the previous section are a small subset of the actual
  ...
  GraphFrames' breadth-first search implementation, which is able to use arbitrary
