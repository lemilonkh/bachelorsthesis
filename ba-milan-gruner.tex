...
\begin{document}
  ...
  an arrow. Vertices and edges don't have to be named if they aren't needed for further evaluation.
  A single definition consists an edge between two nodes, and these constructions are
  ...
  In the end, the final are stored in the $graphs$ table in the same
  ...
  processing the huge amounts of data contained in the data lake). Also, the inclusion
  of automatically extracted relations holds many challenges of its own, because
